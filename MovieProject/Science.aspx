<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Science.aspx.cs" Inherits="MovieProject.Science" %>
...
<RowStyle CssClass="rowsGrid"></RowStyle>
        ...
        <div class="info col-sm-8">     
           ...
           <div class="movieinfo col-sm-7 col align-self-end">
            ...
            <asp:Label ID="LabelResult" runat="server" Text="Science-Fiction Section" CssClass="resultStyle"></asp:Label>
             </div>
